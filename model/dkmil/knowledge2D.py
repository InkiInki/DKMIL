...
class DataDriven:
    ...
    def __init__(self, data_set, in_channels=1):
        """"""
...
def main():
    ...
    knowledge = DataDriven(te_data)
    knowledge.fit()


def main1():
    bag = torch.rand(10, 1, 1, 28, 28)
    knowledge = DataDrivenBag(bag, in_channels=1, ratio=0.2)
    knowledge.fit()
